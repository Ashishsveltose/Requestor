...
<div class="pcoded-main-container">
    <div class="pcoded-content">
        ...
        <a href="https://supporthub.xytr.org/requester/addticket" class="btn btn-primary" style="margin-bottom:20px">Create Ticket</a>
          </div>
               <div class="row">
                        ...
                        <div class="card support-bar overflow-hidden">
                            <div class="card-body pb-0">
                             <div class="row">
                                    <div class="col-md-8 col-xl-8 col-lg-8">
<h4 class=" ">
<?php echo $pd =  $this->Common_model->getRecordCount('ticket_list',array('req_name'=>$session_userdata['id'],'status'=>0));?>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="row align-items-center">
                                    <div class="col-8">
<h4 class=" ">
<?php echo $pd =  $this->Common_model->getRecordCount('ticket_list',array('req_name'=>$session_userdata['id'],'status'=>1));?>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="row align-items-center">
                                    <div class="col-8">
<h4 class="">
<?php echo $pd =  $this->Common_model->getRecordCount('ticket_list',array('req_name'=>$session_userdata['id'],'status'=>2));?>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="row align-items-center">
                                    <div class="col-9">
<h4 class=" ">
<?php echo $pd =  $this->Common_model->getRecordCount('ticket_list',array('req_name'=>$session_userdata['id'],'status'=>3));?>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="row align-items-center">
                                    <div class="col-8">
<h4 class="">
<?php echo $pd =  $this->Common_model->getRecordCount('ticket_list',array('req_name'=>$session_userdata['id'],'status'=>4));?>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="row align-items-center">
                                    <div class="col-8">
<h4 class=" ">
<?php echo $pd =  $this->Common_model->getRecordCount('ticket_list',array('req_name'=>$session_userdata['id'],'status'=>5));?>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="row align-items-center">
                                    <div class="col-8">
<h4 class=" ">
<?php echo $pd =  $this->Common_model->getRecordCount('ticket_list',array('req_name'=>$session_userdata['id'],'status'=>6));?>
