...
<?php } if($getdata['status'] == 4){?>
                        ...
                        <?php } ?>      
                          <td>
                                            <a href="https://supporthub.xytr.org/requester/welcome/replyview/<?php echo htmlspecialchars($getdata['id']); ?>" >
...
<td>
<a href="<?php echo base_url('/upload/channels/' . urlencode($getdata['attachment'])); ?>" target="_blank">
...
<script>
    function business() {
        ...
        window.location.href = 'https://supporthub.xytr.org/requester/addticket';
    }
</script>
