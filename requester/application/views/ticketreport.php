    ...
    foreach ($taxlist as $getdata) { 
       ...
       ?>
                                          <tr>
                                            ...
                                            <td><?php echo (!empty($getdata['ticket_id']) ? $getdata['ticket_id'] : 'none'); ?></td>
                                            <td><?php echo (!empty($getdata['ticket_details']) ? $getdata['ticket_details'] : 'none'); ?></td>
                                            ...
                                            <td><?php echo (!empty($getdata['effort']) ? $getdata['effort'] : 'none'); ?></td>
