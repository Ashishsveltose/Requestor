...
<input type="text" class="form-control" id="exampleInputEmail1"value="<?php if(!empty($tax_data['company_name'])){echo $tax_data['company_name'];}else{echo '';}?>" name="company_name" aria-describedby="emailHelp" placeholder="Enter company name">
                                    
    </div>
	 <div class="col-md-6">
 <label for="exampleInputEmail1">Requestor Name
</label>
<input type="text" class="form-control" id="exampleInputEmail1"value="<?php if(!empty($tax_data['req_name'])){echo $tax_data['req_name'];}else{echo '';}?>" name="req_name" aria-describedby="emailHelp" placeholder="Enter requester name">
                                    
    </div>
	 <div class="col-md-6">
 <label for="exampleInputEmail1">Phone No
</label>
<input type="text" class="form-control" id="exampleInputEmail1"value="<?php if(!empty($tax_data['phone_no'])){echo $tax_data['phone_no'];}else{echo '';}?>" name="phone_no" aria-describedby="emailHelp" placeholder="Enter Phone Number">
       </div>
    <div class="col-md-6">
...
<input type="file" class="form-control" id="exampleInputEmail1"value="<?php if(!empty($tax_data['logo'])){echo $tax_data['logo'];}else{echo '';}?>" name="logo" aria-describedby="emailHelp" placeholder="Enter logo">
<?php 
echo !empty($tax_data['logo']) 
    ? '<img src="https://chauffit.com/ticket_admin/upload/channels/' . $tax_data['logo'] . '" style="width:50px;height:50px">' 
    : ''; 
?>
    </div>
        </div>
 ...
 <hr>
 <form method="post" action="https://chauffit.com/requester/welcome/editprofile1/<?php echo $session_userdata['id']; ?>">
    <div class="row">
        <!-- Current Password -->
        <div class="col-md-6">
