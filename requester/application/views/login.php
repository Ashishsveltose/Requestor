                ...
                <form method="post">
					<div class="card-body">
                      ...
                      <img src="https://supporthub.xytr.org/manager/images/xytr.jpg" style="width:180px;height:90px" alt="24"/>
						...
						<p class="mb-2 text-muted">Forgot password? <a href="https://supporthub.xytr.org/requester/forgetpass" class="f-w-400">Reset</a></p>
						
						<p class="mb-0 text-muted">Don’t have an account? <a href="https://supporthub.xytr.org/ticket_admin/signup" class="f-w-400">Signup</a></p>
					</div>
                    </form>
				</div>
			</div>
